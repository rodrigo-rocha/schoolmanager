...
List<Course> courseList = [
  new Course("Human-Computer Interaction", "12345", "DETI", "Gonçalo Faria","",[new Exam('Mini-test 1', '20', '4.1.20', DateTime.parse("2019-05-12")),new Exam('Mini-test 2', '20', '4.1.15', DateTime.now())]),
